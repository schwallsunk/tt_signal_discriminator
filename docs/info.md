...
0 = low thresh, 1 = high thresh, 2 = MUX IO DLY 0, 3 = MUX IO DLY 1, 4 = shift to buffer, 5 = MUX IO CNTR 0, 6 = MUX IO CNTR 1
...
The counter value is shifted into the register by rising edge of u_in[4]. 
